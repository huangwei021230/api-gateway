module github.com/huangwei021230/api-gateway/hertz-http-server
...
require (
	...
	github.com/huangwei021230/api-gateway/microservices/addition-service v0.0.0-20230720080627-6bb36a64f21c
)
