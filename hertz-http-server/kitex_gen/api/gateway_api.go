...
func (p *GatewayAddNumbersArgs) DeepEqual(ano *GatewayAddNumbersArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *GatewayAddNumbersResult) DeepEqual(ano *GatewayAddNumbersResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *GatewayMultiplyNumbersArgs) SetReq(val *MultiplicationRequest) {
	p.Req = val
}
...
func (p *GatewayMultiplyNumbersArgs) DeepEqual(ano *GatewayMultiplyNumbersArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *GatewayMultiplyNumbersResult) InitDefault() {
	*p = GatewayMultiplyNumbersResult{}
}
...
func (p *GatewayMultiplyNumbersResult) DeepEqual(ano *GatewayMultiplyNumbersResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *GatewayDivideNumbersArgs) DeepEqual(ano *GatewayDivideNumbersArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *GatewayDivideNumbersResult) DeepEqual(ano *GatewayDivideNumbersResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
